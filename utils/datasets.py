...
from utils.general import xyxy2xywh, xywhn2xyxy, xyn2xy, segment2box, segments2boxes, \
    resample_segments
...
class LoadMultiModalImagesAndLabels(Dataset):  # for training/testing
    ...
    def __init__(self, path_rgb, path_ir, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
        ...
        try:
            ...
            assert self.img_files_rgb and self.img_files_ir, f'{prefix}No paired RGB/IR images found'
